...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAlsoKnownAs = (TextView)findViewById(R.id.also_known_tv);
        txtPlaceOfOrigin = (TextView)findViewById(R.id.origin_tv);
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        for (String alsoKnownAsValue : sandwich.getAlsoKnownAs()){
            alsoKnownAs += alsoKnownAsValue +", ";
        }
        txtAlsoKnownAs.setText(alsoKnownAs);

        txtDescription.setText(sandwich.getDescription());
        txtPlaceOfOrigin.setText(sandwich.getPlaceOfOrigin());

        for (String ingredientsValue : sandwich.getIngredients()){
